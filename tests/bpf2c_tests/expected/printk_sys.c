...
#line 19 "sample/undocked/printk.c"
{
#line 19 "sample/undocked/printk.c"
    // Prologue.
#line 19 "sample/undocked/printk.c"
...
#line 24 "sample/undocked/printk.c"
...
#line 25 "sample/undocked/printk.c"
...
#line 28 "sample/undocked/printk.c"
...
#line 29 "sample/undocked/printk.c"
...
#line 30 "sample/undocked/printk.c"
...
#line 31 "sample/undocked/printk.c"
    WRITE_ONCE_32(r10, (uint32_t)r1, OFFSET(-16));
...
#line 32 "sample/undocked/printk.c"
...
#line 32 "sample/undocked/printk.c"
    ...
    // EBPF_OP_LDXH pc=77 dst=r4 src=r7 offset=20 imm=0
#line 32 "sample/undocked/printk.c"
    READ_ONCE_16(r4, r7, OFFSET(20));
    // EBPF_OP_LDXW pc=78 dst=r3 src=r7 offset=16 imm=0
#line 32 "sample/undocked/printk.c"
...
#line 33 "sample/undocked/printk.c"
    r1 = IMMEDIATE(117);
...
#line 32 "sample/undocked/printk.c"
    r6 += r0;
    // EBPF_OP_LDXW pc=93 dst=r5 src=r7 offset=24 imm=0
#line 33 "sample/undocked/printk.c"
    READ_ONCE_32(r5, r7, OFFSET(24));
    // EBPF_OP_LDXH pc=94 dst=r4 src=r7 offset=20 imm=0
#line 33 "sample/undocked/printk.c"
    READ_ONCE_16(r4, r7, OFFSET(20));
    // EBPF_OP_LDXW pc=95 dst=r3 src=r7 offset=16 imm=0
#line 33 "sample/undocked/printk.c"
    READ_ONCE_32(r3, r7, OFFSET(16));
...
#line 37 "sample/undocked/printk.c"
...
#line 38 "sample/undocked/printk.c"
    WRITE_ONCE_64(r10, (uint64_t)r1, OFFSET(-32));
...
#line 39 "sample/undocked/printk.c"
    WRITE_ONCE_64(r10, (uint64_t)r1, OFFSET(-32));
...
#line 39 "sample/undocked/printk.c"
    WRITE_ONCE_8(r10, (uint8_t)r8, OFFSET(-24));
    // EBPF_OP_LDXW pc=125 dst=r3 src=r7 offset=16 imm=0
#line 39 "sample/undocked/printk.c"
    READ_ONCE_32(r3, r7, OFFSET(16));
...
#line 40 "sample/undocked/printk.c"
    WRITE_ONCE_64(r10, (uint64_t)r1, OFFSET(-32));
    // EBPF_OP_ADD64_REG pc=133 dst=r6 src=r0 offset=0 imm=0
#line 39 "sample/undocked/printk.c"
    r6 += r0;
    // EBPF_OP_LDXW pc=134 dst=r3 src=r7 offset=16 imm=0
#line 40 "sample/undocked/printk.c"
    READ_ONCE_32(r3, r7, OFFSET(16));
...
#line 44 "sample/undocked/printk.c"
    WRITE_ONCE_32(r10, (uint32_t)r1, OFFSET(-32));
...
#line 44 "sample/undocked/printk.c"
    ...
    // EBPF_OP_LDXW pc=143 dst=r3 src=r7 offset=16 imm=0
#line 44 "sample/undocked/printk.c"
    READ_ONCE_32(r3, r7, OFFSET(16));
...
#line 45 "sample/undocked/printk.c"
    WRITE_ONCE_64(r10, (uint64_t)r1, OFFSET(-32));
...
#line 48 "sample/undocked/printk.c"
...
#line 50 "sample/undocked/printk.c"
    r0 = r6;
