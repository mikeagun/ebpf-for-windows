...
// This file was generated from sample_bpf2bpf.o
...
#define metadata_table sample_bpf2bpf##_metadata_table
...
#line 51 "sample/undocked/sample_bpf2bpf.c"
{
#line 51 "sample/undocked/sample_bpf2bpf.c"
    // Prologue.
#line 51 "sample/undocked/sample_bpf2bpf.c"
...
#line 58 "sample/undocked/sample_bpf2bpf.c"
    r1 = r10;
    // EBPF_OP_ADD64_IMM pc=8 dst=r1 src=r0 offset=0 imm=-32
#line 55 "sample/undocked/sample_bpf2bpf.c"
    r1 += IMMEDIATE(-32);
    // EBPF_OP_CALL pc=9 dst=r0 src=r1 offset=0 imm=35
#line 59 "sample/undocked/sample_bpf2bpf.c"
...
#line 60 "sample/undocked/sample_bpf2bpf.c"
...
#line 64 "sample/undocked/sample_bpf2bpf.c"
...
#line 65 "sample/undocked/sample_bpf2bpf.c"
    WRITE_ONCE_32(r10, (uint32_t)r1, OFFSET(-4));
...
#line 68 "sample/undocked/sample_bpf2bpf.c"
...
#line 70 "sample/undocked/sample_bpf2bpf.c"
    WRITE_ONCE_32(r10, (uint32_t)r1, OFFSET(-4));
...
#line 72 "sample/undocked/sample_bpf2bpf.c"
    WRITE_ONCE_32(r10, (uint32_t)r1, OFFSET(-4));
...
#line 73 "sample/undocked/sample_bpf2bpf.c"
...
#line 76 "sample/undocked/sample_bpf2bpf.c"
...
#line 87 "sample/undocked/sample_bpf2bpf.c"
    if (r1 == IMMEDIATE(0)) {
#line 87 "sample/undocked/sample_bpf2bpf.c"
        goto label_1;
#line 87 "sample/undocked/sample_bpf2bpf.c"
...
#line 91 "sample/undocked/sample_bpf2bpf.c"
    return r0;
}
...
metadata_table_t sample_bpf2bpf_metadata_table = {
