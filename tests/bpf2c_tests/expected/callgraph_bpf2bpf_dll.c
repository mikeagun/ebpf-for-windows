...
#line 130 "sample/undocked/callgraph_bpf2bpf.c"
{
#line 130 "sample/undocked/callgraph_bpf2bpf.c"
    // Prologue.
#line 130 "sample/undocked/callgraph_bpf2bpf.c"
...
#line 138 "sample/undocked/callgraph_bpf2bpf.c"
    r1 = r6;
...
#line 139 "sample/undocked/callgraph_bpf2bpf.c"
    r1 = r6;
...
#line 145 "sample/undocked/callgraph_bpf2bpf.c"
    if (r7 == IMMEDIATE(2)) {
#line 145 "sample/undocked/callgraph_bpf2bpf.c"
        goto label_1;
#line 145 "sample/undocked/callgraph_bpf2bpf.c"
...
#line 62 "sample/undocked/callgraph_bpf2bpf.c"
    WRITE_ONCE_64(r10, (uint64_t)r1, OFFSET(-8));
    // EBPF_OP_CALL pc=1 dst=r0 src=r0 offset=0 imm=19
#line 65 "sample/undocked/callgraph_bpf2bpf.c"
    r0 = runtime_context->helper_data[3].address(r1, r2, r3, r4, r5, context);
    // EBPF_OP_LDXDW pc=2 dst=r1 src=r10 offset=-8 imm=0
#line 68 "sample/undocked/callgraph_bpf2bpf.c"
...
#line 69 "sample/undocked/callgraph_bpf2bpf.c"
...
#line 71 "sample/undocked/callgraph_bpf2bpf.c"
    WRITE_ONCE_32(r10, (uint32_t)r1, OFFSET(-4));
...
#line 72 "sample/undocked/callgraph_bpf2bpf.c"
...
#line 75 "sample/undocked/callgraph_bpf2bpf.c"
    goto label_6;
label_2:
    // EBPF_OP_MOV64_REG pc=15 dst=r2 src=r10 offset=0 imm=0
#line 78 "sample/undocked/callgraph_bpf2bpf.c"
    r2 = r10;
...
#line 85 "sample/undocked/callgraph_bpf2bpf.c"
    r0 = runtime_context->helper_data[0].address(r1, r2, r3, r4, r5, context);
    // EBPF_OP_STXDW pc=20 dst=r10 src=r0 offset=-48 imm=0
#line 86 "sample/undocked/callgraph_bpf2bpf.c"
...
#line 112 "sample/undocked/callgraph_bpf2bpf.c"
    WRITE_ONCE_32(r10, (uint32_t)r1, OFFSET(-36));
...
#line 116 "sample/undocked/callgraph_bpf2bpf.c"
    r2 += IMMEDIATE(-24);
...
#line 117 "sample/undocked/callgraph_bpf2bpf.c"
    r4 = IMMEDIATE(0);
...
#line 118 "sample/undocked/callgraph_bpf2bpf.c"
...
#line 151 "sample/undocked/callgraph_bpf2bpf.c"
{
#line 151 "sample/undocked/callgraph_bpf2bpf.c"
    // Prologue.
#line 151 "sample/undocked/callgraph_bpf2bpf.c"
...
#line 151 "sample/undocked/callgraph_bpf2bpf.c"
    WRITE_ONCE_64(r10, (uint64_t)r1, OFFSET(-8));
    // EBPF_OP_CALL pc=2 dst=r0 src=r0 offset=0 imm=19
#line 155 "sample/undocked/callgraph_bpf2bpf.c"
    r0 = runtime_context->helper_data[3].address(r1, r2, r3, r4, r5, context);
...
#line 157 "sample/undocked/callgraph_bpf2bpf.c"
    r0 = ScenarioS2(r1, r2, r3, r4, r5, r10, context, runtime_context);
...
#line 159 "sample/undocked/callgraph_bpf2bpf.c"
    if (r1 != IMMEDIATE(2)) {
#line 159 "sample/undocked/callgraph_bpf2bpf.c"
        goto label_1;
#line 159 "sample/undocked/callgraph_bpf2bpf.c"
...
#line 163 "sample/undocked/callgraph_bpf2bpf.c"
    return r0;
#line 151 "sample/undocked/callgraph_bpf2bpf.c"
}
#pragma code_seg(pop)
...
#line 169 "sample/undocked/callgraph_bpf2bpf.c"
{
#line 169 "sample/undocked/callgraph_bpf2bpf.c"
    // Prologue.
#line 169 "sample/undocked/callgraph_bpf2bpf.c"
...
#line 172 "sample/undocked/callgraph_bpf2bpf.c"
...
#line 174 "sample/undocked/callgraph_bpf2bpf.c"
    if (r1 != IMMEDIATE(0)) {
#line 174 "sample/undocked/callgraph_bpf2bpf.c"
        goto label_1;
#line 174 "sample/undocked/callgraph_bpf2bpf.c"
...
#line 179 "sample/undocked/callgraph_bpf2bpf.c"
    return r0;
#line 169 "sample/undocked/callgraph_bpf2bpf.c"
}
#pragma code_seg(pop)
