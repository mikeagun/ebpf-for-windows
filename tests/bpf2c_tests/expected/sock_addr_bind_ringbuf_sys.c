...
// This file was generated from sock_addr_bind_ringbuf.o
...
#define metadata_table sock_addr_bind_ringbuf##_metadata_table
...
#line 49 "sample/sock_addr_bind_ringbuf.c"
{
#line 49 "sample/sock_addr_bind_ringbuf.c"
    // Prologue.
#line 49 "sample/sock_addr_bind_ringbuf.c"
...
#line 41 "sample/sock_addr_bind_ringbuf.c"
...
#line 42 "sample/sock_addr_bind_ringbuf.c"
    r1 = POINTER(runtime_context->map_data[0].address);
    // EBPF_OP_MOV64_IMM pc=10 dst=r3 src=r0 offset=0 imm=4
#line 42 "sample/sock_addr_bind_ringbuf.c"
    r3 = IMMEDIATE(4);
    // EBPF_OP_MOV64_IMM pc=11 dst=r4 src=r0 offset=0 imm=0
#line 42 "sample/sock_addr_bind_ringbuf.c"
    r4 = IMMEDIATE(0);
    // EBPF_OP_CALL pc=12 dst=r0 src=r0 offset=0 imm=11
#line 42 "sample/sock_addr_bind_ringbuf.c"
    r0 = runtime_context->helper_data[0].address(r1, r2, r3, r4, r5, context);
    // EBPF_OP_MOV64_IMM pc=13 dst=r0 src=r0 offset=0 imm=1
#line 51 "sample/sock_addr_bind_ringbuf.c"
    r0 = IMMEDIATE(1);
    // EBPF_OP_EXIT pc=14 dst=r0 src=r0 offset=0 imm=0
#line 51 "sample/sock_addr_bind_ringbuf.c"
    return r0;
#line 49 "sample/sock_addr_bind_ringbuf.c"
}
...
#line 56 "sample/sock_addr_bind_ringbuf.c"
{
#line 56 "sample/sock_addr_bind_ringbuf.c"
    // Prologue.
#line 56 "sample/sock_addr_bind_ringbuf.c"
...
#line 42 "sample/sock_addr_bind_ringbuf.c"
    r0 = runtime_context->helper_data[0].address(r1, r2, r3, r4, r5, context);
    // EBPF_OP_MOV64_IMM pc=13 dst=r0 src=r0 offset=0 imm=1
#line 58 "sample/sock_addr_bind_ringbuf.c"
    r0 = IMMEDIATE(1);
    // EBPF_OP_EXIT pc=14 dst=r0 src=r0 offset=0 imm=0
#line 58 "sample/sock_addr_bind_ringbuf.c"
    return r0;
...
metadata_table_t sock_addr_bind_ringbuf_metadata_table = {
