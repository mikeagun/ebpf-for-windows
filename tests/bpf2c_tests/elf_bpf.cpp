...
DECLARE_TEST("sample_bpf2bpf", _test_mode::Verify)
DECLARE_TEST("sample_ringbuf", _test_mode::Verify)
...
DECLARE_TEST("sock_addr_bind_mt_tailcall", _test_mode::Verify)
DECLARE_TEST("sock_addr_bind_ringbuf", _test_mode::Verify)
