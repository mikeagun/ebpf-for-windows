 ...
 * Available for CONNECT_AUTHORIZATION, RECV_ACCEPT, and LISTEN attach types.
 */
...
/**
 * @brief Get the network context for the connection (CONNECT_AUTHORIZATION, RECV_ACCEPT, and LISTEN).
 *
 * @param[in] ctx Pointer to bpf_sock_addr_t context.
