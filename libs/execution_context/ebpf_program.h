...
extern "C"
{
    ...
    /**
     * @brief Set the program information in the program context header.
     *  Writes a pointer to the ebpf_program_t object to Slot [1].
     *
     *  Extension must support context headers.
     *
     * @param[in] program Pointer to the program object.
    ...
    /**
     * @brief Get the program information from the program context header.
     *  Slot [1] contains a pointer to the ebpf_program_t object.
     *
     *  Extension must support context headers.
     *
     * @param[in] program_context Pointer to the program context.
     * @param[out] program Pointer to the program object.
     */
    void
     ...
     *  Looks up the descriptor from the program pointer in Slot [1].
     *
     *  Extension must support context headers.
     *
     * @param[in] program_context Pointer to the program context.
     ...
     *
     *  Extension must support context headers to get the data start and end pointer offsets.
     *
     * @param[in] program_context Pointer to the program context.
